...
- [ ] Drilling on a screen — one card at a time, marked by the server, with the day it comes back said out loud. **Ticked in `e754f35` while the screen could not do it:** it counted the queue and said "the questions themselves are not in this school yet", and nothing was wired to `draw` or `answered`. The routes were real; the screen was a number. It is the item this audit was written around, and the branch that earns it is open
