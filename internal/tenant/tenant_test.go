...
// `twelve` above is a function: it is a dated series settable from the
// console, so a number captured at construction would be stale by a day.
func fivePerCent(context.Context) int { return 500 }
