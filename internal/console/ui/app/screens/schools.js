...
export default async function schools(section) {
  ...
  el.innerHTML =
    '<header class="view-head">' +
      ...
      '<h1>Schools</h1>' +
      '<p>One colour each. It is the only thing that differs between them — one ' +
      'design system, one accent — so a student knows which school they are in ' +
      'without the product looking like two products. Every change is recorded ' +
      'with your name, the colour that was there and the one that replaced it.</p>' +
    '</header>' +
