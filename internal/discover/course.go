...
var words = map[string]map[string]string{
	"en": {
		...
		"coursesAre": "Every course this school teaches, with what each one covers and what you need before it.",
		"tracksAre":  "Every track this school teaches: what each one is for, and the courses in the order they are taken.",
	...
	"pt": {
		...
		"coursesAre": "Todos os cursos desta escola, com o que cada um cobre e o que você precisa antes dele.",
		"tracksAre":  "Todas as trilhas desta escola: para que serve cada uma e os cursos na ordem em que são feitos.",
		"read":       "Ler esta aula",
