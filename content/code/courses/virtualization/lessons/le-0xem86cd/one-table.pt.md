...
As linhas que mais importam para o suporte são **disco**, porque um disco sempre pode ser levado a outro
hypervisor e convertido, aula 5, e **agente**, porque um convidado sem o agente dele é a causa de muitas
reclamações pequenas: uma tela que não muda de tamanho, uma área de transferência que não faz nada, um
