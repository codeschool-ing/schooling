...
# a week of the bakery's site, nine commits by Ana and Bruno, made by the
# helper `c` with dates and authors set through GIT_AUTHOR_* and
# GIT_COMMITTER_*; and one uncommitted edit to menu.html for the first diff.
...
show 'git log --oneline --since=2026-09-17'
