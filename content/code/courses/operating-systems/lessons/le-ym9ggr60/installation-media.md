...
skip it when the machine has a digital licence), for the edition when the key does not decide it, and
then the question the next section is about: **where do you want to install Windows?**
