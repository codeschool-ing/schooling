...
**Carga 1,39 numa máquina de quatro núcleos, e o disco a 93% de utilização.** Só
com a carga média você fecharia o chamado. O `b 1` e o `wa 22` são a história de
verdade, e estão nas próximas duas seções.
