...
var wiped = map[string]string{
	...
	"ratings": "what anybody thought of a course. Emptied for the reason the line " +
		"above is: it is one person's opinion and the people are going. A count of stars that " +
		"outlived every student who gave one would be the platform quoting a public it no " +
		"longer has",
