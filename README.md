...
| [`docs/PLAN.md`](docs/PLAN.md) | why each rule exists: 99 decisions with their reasoning, the open questions, the shape of the phases |
...
| [`docs/VIDEO.md`](docs/VIDEO.md) | how video is **made**, hosted, delivered, protected and measured, what it costs, and what was deferred or refused — the decisions it settled are P-11, P-12, C-18 to C-20, C-29 to C-35, K-23 and K-24 |
