...
| [`docs/PLAN.md`](docs/PLAN.md) | why each rule exists: 88 decisions with their reasoning, the open questions, the shape of the phases |
...
| [`docs/RELEASES.md`](docs/RELEASES.md) | how a course is published as one versioned set, what major/minor/fix mean, and what happens to a student mid-course when the structure changes — the decisions it settled are C-21 to C-24, N-11, K-25 and K-26 |
